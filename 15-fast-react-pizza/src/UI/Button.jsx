...
export default function Button({children,disabled, to, type }) {
  ...
  const base = "inline-block font-semibold uppercase text-stone-800 tracking-wide rounded-full bg-yellow-400 transition-colors duration-300 hover:bg-yellow-300 focus:bg-yellow-300 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-2 disabled:cursor-not-allowed  "
  const styles = { 
